...
<div class="overview-grid">
    <div>
        <table class="info-table">
            <tr><td>Test start time</td><td>{test_start_display} ({relative_start_ts:.4f})</td></tr>
            <tr><td>Test end time</td><td>{test_end_display} ({relative_end_ts:.6f})</td></tr>
