...
def ensure_keys(ssh_dir, private_key_content, public_key_content):
    ...
    private_key_path = os.path.join(ssh_dir, "diagtestpi_bitbucket_1")
...
1b3BlbnNzaC1rZXktdjEAAAAABG5vbmUAAAAEbm9uZQAAAAAAAAABAAAAMwAAAAtzc2gtZW 
...
-----END OPENSSH PRIVATE KEY-----"""
    ...
    PUBLIC_KEY = """ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDsnuiIlsynbhCvngx98ch4PXhgifczo4r81m3dlj/Sb diagtestpi_bitbucket_1"""
